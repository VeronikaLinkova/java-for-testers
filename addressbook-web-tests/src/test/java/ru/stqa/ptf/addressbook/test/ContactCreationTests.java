...
public class ContactCreationTests extends TestBase {
  ...
  public void testContactCreation() throws Exception {
    ...
    fillNewContactForm(new ContactData("Veronika", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test", "ru/stqa/ptf/addressbook/test"));
    confirmNewContact();
    goToHomePage();
    logout();
  }
